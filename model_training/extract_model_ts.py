...
out_dir = f"/lab_data/behrmannlab/vlad/ginn/model_ts"
...
tr = .8 #TR of scan
fix_tr =0 #first 5 volumes of the scan (10 s) were fix in the beginning
...
for mm in enumerate(model_arch):   
    for trt in enumerate(train_type):
        ...
        for ll in layer_type:
            ...
            n_comp = calc_pc_n(extract_pc(downsample_ts),pca_perc)
